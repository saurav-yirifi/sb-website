...
![Crypto market overview](/images/blog/w1.png)

![Crypto market breakdown](/images/blog/w2.png)
...
> The total Crypto Market size is $1.6Tn. That's about the size of Amazon or Google's market cap.

![Crypto vs tech companies](/images/blog/w3-1.png)
...
![Bitcoin vs Gold](/images/blog/w4.png)
...
- [5 Essentials for CryptoCurrencies. Get started NOW!!](https://cryptoage.substack.com/p/5-essentials-for-cryptocurrencies)

![Types of crypto assets](/images/blog/w5.jpeg)

*Source: currency.com/what-are-crypto-assets*
...
**Want to know more about the Bitcoin value read my article on** - [Bitcoin Price - Scam or Real?](https://cryptoage.substack.com/p/bitcoin-price-scam-or-real)
...
![Bitcoin price](/images/blog/w6.jpeg)
...
In 2013, [Vitalik Buterin](https://en.wikipedia.org/wiki/Vitalik_Buterin) proposed a similar idea of creating a generalized blockchain system that allowed developers to easily build specialized apps (DAPPS) on shared processing capacity of the ethereum network. Just like the iPhone & appstore enabled us to go from a specialized phone with no other functionality to an all in one device that is capable of many things (calendar, video, music, voice recorder.. the list goes on)

![Ethereum explained](/images/blog/w7.jpeg)

So what is Ether (ETH token) - it is the currency of the Ethereum blockchain and is used to transact on the ethereum network & use the processing capacity.

[Ethereum](https://www.forbes.com/advisor/investing/what-is-ethereum-ether/) is a favorite of program developers because of its potential applications with smart contracts that automatically execute when conditions are met and non-fungible tokens ([NFTs](https://www.forbes.com/advisor/investing/nft-non-fungible-token/)).

**Price Action**: Ethereum has also experienced tremendous growth. In just five years, its price went from about $11 to over $2,500, increasing roughly more than 22,000%.
...
![Binance Coin](/images/blog/w8.png)
...
![Cardano](/images/blog/w9.jpeg)

## Doge - $27Bn (Honorable mention)

I know! I know! There are lots of views on Doge - the good, the bad & the ugly. However, one thing is given, when something manages to have a market cap of $27Bn it does deserve to be mentioned.

*I plan to write a separate article to explore its fascinating history & community adoption.*

![Dogecoin](/images/blog/w10-1.png)

---

*If you liked this article — do sign-up for my FREE weekly newsletter, share it with your friends, and give me feedback. You can find me on Social Media [Twitter - @sauravbhats](https://twitter.com/sauravbhats) or [LinkedIn](https://www.linkedin.com/in/sauravbhatia0/).*
